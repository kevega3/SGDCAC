...
LEFT JOIN historialrespuestas HR ON P.IdRespuesta = HR.IdRespuesta 
WHERE IdPeticion = '$id'";
...
<body class="w3-light-grey">
  ...
  <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      ...
      <div class="w3-col w3-container w3-white" style="padding-bottom: 16px;">
        <div class="w3-twothird w3-container w3-text-indigo">
          <div class="w3-half">
            ...
            <input type="text" class="w3-input w3-border" name="tema" readonly value="<?php echo $fila['temaPeticion']; ?>" style="width: 90%;">
          </div>
          <div class="w3-half">
            <label><b>Estado:</b></label>
            <input type="text" class="w3-input w3-border" name="tema" readonly value="<?php echo $fila['EstadoPeticion']; ?>">
          </div> 
          <br>
          <br>
    ...
    <button class="accordion">Anexos a esta solicitud</button>
    <div class="panel">
      <div class="w3-col w3-container w3-white" style="padding-bottom: 16px;">
        <div class="w3-container w3-text-indigo">
          ...
          <table class="w3-table w3-striped w3-bordered">
            ...
            <tbody>
             ...
             $anexos = "SELECT * FROM anexos A INNER JOIN peticiones P ON P.numRadicado = A.numRadicado WHERE anexadoA = '$idpeticion'";
             ...
             while ($row = $salida->fetch_assoc()) {?>
              ...
              <tr>
                ...
                <td><?php echo $row['fechaAnexo']; ?></td>
                <td><a href="ver.php?Id=<?php echo $fila['IdPeticion']; ?>" class="botonVer">Ver</a></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
