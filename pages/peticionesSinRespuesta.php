...
<!DOCTYPE html>
<html>
<title>Peticiones sin respuesta</title>
<meta charset="UTF-8">
...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
      ...
      <a href="peticionesSinRespuesta.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-comment-slash fa-fw"></i>  No respuesta</a>
    </div>
...
<?php
  ...
  <div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
      <h5><b><i class="fa fa-comment-slash fa-fw" style="color: #673ab7;"></i> No respuesta</b></h5>
    </header>
    <hr>
    <?php 
    $usuario = $_SESSION['IdUsuario'];
    include ('conexion.php');
    $sentencia = "SELECT IdPeticion,numRadicado,FechaCreacion,TP.Descripcion AS TipoPeticion, T.Descripcion AS TipoPersona, Correo,temaPeticion,IdUsuarioAsignado 
    FROM peticiones P 
    ...
    WHERE IdUsuarioAsignado = '$usuario' AND IdEstadoPeticion = 5 ORDER BY IdPeticion";
    $resultado = $mysqli->query($sentencia);
    ?>
    <div class="w3-container">
      <table id="TablaHistorial" class="display table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        <thead>
          <tr>
            <th>Radicado</th>
        ...
        <tbody>
          ...
          while($fila = $resultado->fetch_assoc()){ ?>
            <tr>
              ...
              <td style="vertical-align: middle"><a href="ver.php?Id=<?php echo $fila['IdPeticion']; ?>" class="botonVer">Ver</td>
              </tr>
            <?php } ?>
          </tbody>
        </table><br>
