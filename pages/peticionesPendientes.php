...
<?php
  ...
  <div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
      <h5><b><i class="fa fa-exclamation-circle fa-fw" style="color: red;"></i> Pendientes</b></h5>
    </header>
    <hr>
    <?php 
    ...
    WHERE IdUsuarioAsignado = '$usuario' AND (IdEstadoPeticion = 1 OR IdEstadoPeticion = 2) ORDER BY IdPeticion";
        ...
        <tbody>
          ...
          while($fila = $resultado->fetch_assoc()){ ?>
            <tr>
              ...
              <td style="vertical-align: middle"><a href="Gestionar.php?Id=<?php echo $fila['IdPeticion']; ?>" class="botonGestionar">Gestionar</td>
              </tr>
            <?php } ?>
          </tbody>
        </table><br>
