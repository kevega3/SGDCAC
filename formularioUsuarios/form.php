						...
						<div class="col-sm-6"> 
							<table class="table-form">
								...
								<tr>
									...
									<td><input type="text" class="campo" name="nombrepersona" onkeypress="return validar_texto(event)" required></td>
									<td><i class="fas fa-question-circle" title="Nombre de la persona que realiza la solicitud"></i></td>
								</tr>
								<tr>
									<td>Apellidos <span>*</span></td>
									<td><input type="text" class="campo" name="apellidospersona" onkeypress="return validar_texto(event)" required></td>
								...
								<tr>
									...
									<td><input type="email" class="campo" name="correo" onkeypress="return varios(event)" required></td>
