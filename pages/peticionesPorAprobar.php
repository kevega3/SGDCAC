...
<!DOCTYPE html>
<html>
<title>Peticiones por aprobar</title>
<meta charset="UTF-8">
...
<?php
  ...
  <div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
      <h5><b><i class="fa fas fa-clock fa-fw" style="color: #ff9800!important;"></i> Por aprobar</b></h5>
    </header>
    <hr>
    <?php 
    ...
    if ($_SESSION['tipoUsuario']==2) {
      ...
      WHERE IdEstadoPeticion = 3 ORDER BY IdPeticion";
    }else{
      $sentencia = "SELECT IdPeticion,numRadicado,FechaCreacion,TP.Descripcion AS TipoPeticion, T.Descripcion AS TipoPersona, Correo,temaPeticion,IdUsuarioAsignado 
      FROM peticiones P 
      INNER JOIN tipopeticion TP ON TP.IdTipoPeticion = P.IdTipoPeticion 
      INNER JOIN tipopersona T ON T.IdTipoPersona = P.IdTipoPersona 
      WHERE IdEstadoPeticion = 3 AND IdUsuarioAsignado = '$usuario' ORDER BY IdPeticion";
    }
        ...
        <tbody>
          ...
          while($fila = $resultado->fetch_assoc()){ ?>
            <tr>
              ...
              if ($_SESSION['tipoUsuario']==2) {
                ?>
                <td style="vertical-align: middle;"><a href="Revision.php?Id=<?php echo $fila['IdPeticion']; ?>" class="botonVer">Revisar</a></td>
                <?php
              }else{
                ?>
